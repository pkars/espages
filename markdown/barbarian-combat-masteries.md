...
but don\'t stack with one another.
The higher level one takes effect.
:::
...
Skill Description
: A weapon mastery that works with any melee weapons. Former *Sword Mastery*,
which means Sword Mastery on LoD items turn into this skill.

Difference from Sword Mastery
: Works with any melee weapons. Improved damage, AR and Critical Strike bonus.

Notes
: Doesn\'t stack with Assassin\'s Melee Mastery. (The higher level one works.)
...
Skill Description
: Increases Vitality in addiition to Run/Walk speed. Former *Increase Speed*.
...
Notes
: Re-equip Damage Augmenter to gain bonuses, Passive Def Bonus for 2H Melee.

Pros
: Works wonders with 1 point and +skills, Double effect with 2 hand weapons.
...
Skill Description
:   A Lightning version of Sorceress\' Blizzard. Former *Pole Arm Mastery*.
...
Pros
: Magic Resist on equipment is rare. Elemental/Poison Resist is also useful, if more common.
...
::: {.slvl-table}
  ...
  Lightning Damage (LoD)     1-100                                  +10   +10    +11     +11  
